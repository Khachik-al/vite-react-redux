...
import { Product, ResponseType } from '../../../interfaces/data.interface'
...
import { updateTutorial, postStepTutorial } from '../../../services/api'
import { EditHtmlTutorial } from './editHtmlTutorial'
import { EditHtmlTutorialStep } from './editHtmlTutorialStep'
...
type Props = {
  ...
  language: Language
  steps: Steps[]
  setTutorial: (t: any) => void
  setLanguage: (l: any) => void
  setSteps: (s: any) => void
}

export const HtmlTutorial: FC<Props> = ({
  tutorial,
  devices,
  language,
  steps,

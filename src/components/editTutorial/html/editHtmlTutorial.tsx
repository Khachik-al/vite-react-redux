...
import type { Customer } from '../../../interfaces/metadata.interface'
import type {
  TutorialsData,
  Category,
  Tutorial,
...
import { ContentStatus } from '../interactive/editTutorial'
...
export const EditHtmlTutorial: FC<Props> = ({
  language,
  setLanguage,
  tutorial,
  devices,
  ...
  return (
    ...
    >
      <Flex flexDir="column" gap="3">
        ...
        <Breadcrumb spacing="1" separator=">" fontWeight="700" mb="8">
          <BreadcrumbItem color="gray.200">
            <BreadcrumbLink href="/content">Content</BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbItem>
            <BreadcrumbLink isCurrentPage>{tutorial.title}</BreadcrumbLink>
          </BreadcrumbItem>
        </Breadcrumb>
      </Flex>
      ...
      <Flex flexDir="column" gap="3" mt={4}>
        ...
        <Box>
          ...
          >
            ...
            >
              {categories
                ?.filter((i) => i.language.id === language.id)
                ?.map((item) => {
                  if (
